...
<qgis version="3.34.11-Prizren">
  <identifier>jalannnn</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>jalannnn</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link format="" name="File Geodatabase Feature Class" mimeType="" description="" type="Local Area Network" url="file://\\PSJSDS-4-PC\G$\TrainingPakuan.gdb" size=""/>
  </links>
  <dates/>
  <fees></fees>
